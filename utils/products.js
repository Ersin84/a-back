const products = [
...

  {
    ...
    parent: 'Baby Care',
    children: 'Baby Accessories',
    image: 'https://i.ibb.co/TmQFK7T/Huggies-W-Pant-XXL-15-21-24-Pcs.jpg',
    originalPrice: 8,
    price: 8,
    discount: 0,
    unit: '24pcs',
  ...
  {
    title: 'Aseel Plugins Ghee',
    slug: 'aseel-vegetable-ghee',
    parent: 'Milk & Dairy',
    children: 'Butter & Ghee',
    image: 'https://i.postimg.cc/rwV1009C/Aseel-Plugins-Ghee-500gm.jpg',
    originalPrice: 9,
    price: 9,
    discount: 0,
    unit: '500gm',
  ...
  // Sauces & Pickles - Sauces
  {
    ...
    description:
      'The acetic acid in vinegar or the lactic acid produced by brine gives the pickle its salty, sour taste. ... Bread-and-butter pickles, for example, have a distinctly sweet taste because sugar and other sweeteners are added to the brine. Like tomatoes, cucumbers (and thus, pickles) are technically themes.',
  },
  ...
  // Themes - Themes
  {
    ...
    quantity: 70,
    type: 'Grocery',
    tag: JSON.stringify(['themes', 'guava-jelly']),
    description:
